...
int xor_test() {
    ...
    _setInput(LOW , LOW , HIGH, LOW , HIGH); _checkOutput(LOW , LOW , LOW );
    ...
    _setInput(LOW , HIGH, LOW , HIGH, LOW ); _checkOutput(LOW , LOW , LOW );
    _setInput(LOW , HIGH, LOW , HIGH, HIGH); _checkOutput(LOW , LOW , HIGH);

    _setInput(LOW , HIGH, HIGH, LOW , LOW ); _checkOutput(LOW , HIGH, HIGH);
    _setInput(LOW , HIGH, HIGH, LOW , HIGH); _checkOutput(LOW , HIGH, LOW );
    _setInput(LOW , HIGH, HIGH, HIGH, LOW ); _checkOutput(LOW , LOW , HIGH);
    _setInput(LOW , HIGH, HIGH, HIGH, HIGH); _checkOutput(LOW , LOW , LOW );
    ...
    _setInput(HIGH, LOW , HIGH, LOW , HIGH); _checkOutput(LOW , LOW , LOW );
    ...
    _setInput(HIGH, HIGH, LOW , HIGH, LOW ); _checkOutput(LOW , LOW , LOW );
    _setInput(HIGH, HIGH, LOW , HIGH, HIGH); _checkOutput(LOW , LOW , HIGH);

    _setInput(HIGH, HIGH, HIGH, LOW , LOW ); _checkOutput(LOW , HIGH, HIGH);
    _setInput(HIGH, HIGH, HIGH, LOW , HIGH); _checkOutput(LOW , HIGH, LOW );
    _setInput(HIGH, HIGH, HIGH, HIGH, LOW ); _checkOutput(LOW , LOW , HIGH);
    _setInput(HIGH, HIGH, HIGH, HIGH, HIGH); _checkOutput(LOW , LOW , LOW );
